...
<%@ include file="header.jsp" %>
	<div class="container text-center p-3">
		<form class="form-login text-center jumbotron pt-4 pb-4" action="./processSignUp.jsp" method="post">
			...
			<input type="text" id="input-id" name="input-id" class="mb-1 p-2 border border-secondary form-control" onkeydown="idCheckReset()">
			...
			<input type="password" id="input-pw-double-check" name="input-pw-check" class="p-2 border border-secondary form-control" onkeyup="pwDoubleCheck()">
